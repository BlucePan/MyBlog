...
<form action="${blog}/voice/manage/videoAdd.html" name="listForm" method="post" >
<div class="maincont othercolor">
  <div class="addmenu">
    <h2 class="addh2">新增视频</h2>
    <div class="add_meunlist">
      <ul>
       ...
       <li><span>是否发布：</span>
        ...
        <li><span>视频：</span>
        	<textarea style="width:90%;height:300px;" name="videoUrl" id ="workstatus"></textarea>
