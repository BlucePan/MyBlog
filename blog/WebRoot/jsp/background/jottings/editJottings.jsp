...
<form action="${blog}/jottings/manage/jottingsUpdate.html" name="listForm" method="post" >
  ...
  <div class="addmenu">
    ...
    <div class="add_meunlist">
      <ul>
        ...
        <li><span>内容：</span>
        	<textarea style="width:90%;height:300px;"  name="context" id ="workstatus">${jottings.context}</textarea>
