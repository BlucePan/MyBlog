...
<form action="${blog}/role/manage/roleUpdate.html" name="listForm" method="post" >
<input type="hidden" name="id" value="${role.id}"/>
<div class="maincont othercolor">
  <div class="addmenu">
    <h2 class="addh2">修改角色</h2>
    <div class="add_meunlist">
      <ul>
        <li><span>角色名称：</span>
          <input type="text" placeholder="" name="name" id="name" value="${role.name}" />
