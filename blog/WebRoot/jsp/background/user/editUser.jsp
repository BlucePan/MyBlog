...
<form action="${blog}/role/manage/userUpdate.html" name="listForm" method="post" >
<input type="hidden" name="id" value="${user.id}"/>
<div class="maincont othercolor">
  <div class="addmenu">
    <h2 class="addh2">修改用户</h2>
    <div class="add_meunlist">
      <ul>
        <li><span>账户：</span>
          <input type="text" placeholder="" value="${user.account}" name="account" id="account" />
        ...
        <li><span>密码：</span>
          <input type="text" placeholder="" value="${user.password}" name="password" id="password" />
