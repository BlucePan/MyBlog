      ...
      <tbody>
        <c:forEach var="v" items="${list}">
          <tr>
            ...
            <td>
            <a href="${blog}/voice/manage/typeArticleList.html?parentCode=${v.catCode}&parentName=${v.articleName}" class="btn goods">类目类别</a>
...
<div class="modelLabel" style="display: none;">
 <form id="labelForm"  name="labelForm" action=""  method="post">
   ...
   <div class="zhuan"><span>类别code：</span>
   <input type="text" id="catCode" name="catCode" value=""></div>    
   <p class="text-align">
...
<script type="text/javascript">
    ...
    function query(){
        document.listForm.action = "${blog}/voice/manage/typeList.html";
