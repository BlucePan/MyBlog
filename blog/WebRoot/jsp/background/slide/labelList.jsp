...
<div class="maincont">
  <form name="listForm" action="" method="post">
    ...
    <a href="#" class="btn goods" onclick="query()">查询</a> <a href="javascript:;" id="addLabel" class="btn goods">新增</a> </div>
  </form>
  <div class="aotable">
      ...
      <tbody>
        <c:forEach var="v" items="${list}">
          <tr>
            ...
            <td>
            <a href="javascript:labelUpdate('${v.id}','${v.name}')" class="btn goods">修改</a>
...
<div class="modelLabel" style="display: none;">
 <form id="labelForm"  name="labelForm" action=""  method="post">
   ...
   <div class="zhuan"><span>标签名称：</span>
...
<script type="text/javascript">
    ...
    function query(){
        document.listForm.action = "${blog}/voice/manage/labelList.html";
	...
	function yes(id) {
		$.ajax({
			...
			url : "${blog}/voice/manage/delLabel.html",
			dataType : 'json',
	...
	if(title == "" || title == undefined || title == null){
	 ...
	 document.labelForm.action = "${blog}/voice/manage/labelAdd.html";
	 document.labelForm.submit();
   	...
   	function updateLabel(){
   		...
   		if(title == "" || title == undefined || title == null){
   		 ...
   		 document.labelForm.action = "${blog}/voice/manage/labelUpdate.html";
   		 document.labelForm.submit();
   	}
