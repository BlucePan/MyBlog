...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>分配权限</title>
    <script src="${oa }/scripts/ligerUI/base.js" type="text/javascript"></script>
    <link href="${oa }/scripts/ligerUI/ligerui-tree.css" rel="stylesheet" type="text/css" />
    <script src="${oa }/scripts/ligerUI/ligerTree.js" type="text/javascript"></script>
             ...
             if(fids == ""){
              ...
              if("${divId}" != ""){
            	 $.ajax({
               		...
               		type : "POST",
               		data:{divId:"${divId}",rescId:fids},
               		url: "${oa }/menu/manage/saveRoleRescours.html",
               		dataType:'json',
