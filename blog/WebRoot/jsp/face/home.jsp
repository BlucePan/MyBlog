...
<header>
  ...
  <nav class="topnav" id="topnav"><a href="${blog}/jsp/face/index.jsp"><span>首页</span><span class="en">Protal</span></a><a href="${blog}/jsp/face/about.jsp"><span>关于我</span><span class="en">About</span></a><a href="${blog}/jsp/face/newlist.jsp"><span>慢生活</span><span class="en">Life</span></a><a href="${blog}/jsp/face/moodlist.jsp"><span>碎言碎语</span><span class="en">Doing</span></a><a href="${blog}/jsp/face/share.jsp"><span>模板分享</span><span class="en">Share</span></a><a href="${blog}/jsp/face/knowledge.jsp"><span>学无止境</span><span class="en">Learn</span></a><a href="${blog}/user/myself.html"><span>留言版</span><span class="en">Gustbook</span></a></nav>
  </nav>
</header>
<div class="banner">
  <section class="box">
...
<article>
  ...
  <div class="bloglist left">
    ...
    <figure><img src="${blog}/img/001.png"></figure>
    <ul>
  ...
  <aside class="right">
    ...
    <script type="${blog}/text/javascript" id="bdshare_js" data="type=tools&amp;uid=6574585" ></script> 
    <script type="${blog}/text/javascript" id="bdshell_js"></script> 
    <script type="${blog}/text/javascript">
